...
namespace BBS.Admin
{
    public partial class DonorDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //MySqlCommand SelectCommand2 = new MySqlCommand("SELECT * FROM bbs.bloodrequest a WHERE a.bloodid='" + s + "' AND reqhospitalid='" + Session["id"] + "' LIMIT 1;", myConn);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.Write("alert('Blood request sucessful !');");
