<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="RequestToDonor.aspx.cs" Inherits="BBS.Admin.RequestToDonor" %>
...
<table><thead>
        <tr class="header" style="height:40px;">
            ...
            <td style="color:White;">Cancel Request</td>
        </tr>
        </thead>
        <%=blooddata%>
