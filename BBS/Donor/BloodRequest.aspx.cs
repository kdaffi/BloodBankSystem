...
namespace BBS.Donor
{
    public partial class BloodRequest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MySqlCommand SelectCommand = new MySqlCommand("SELECT * FROM bbs.bloodrequest a JOIN bbs.hospital b ON a.reqhospitalid=b.hospitalid WHERE a.donorid='" + Session["id"] + "' UNION SELECT * FROM bbs.bloodrequest a JOIN bbs.admin b ON a.reqhospitalid=b.adminid WHERE a.donorid='" + Session["id"] + "' ORDER BY daterequest;", myConn);
