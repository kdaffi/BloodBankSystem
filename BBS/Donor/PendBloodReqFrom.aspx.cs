...
namespace BBS.Donor
{
    public partial class PendBloodReqFrom : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MySqlCommand SelectCommand = new MySqlCommand("SELECT * FROM bbs.bloodrequest c JOIN bbs.hospital b ON b.hospitalid=c.reqhospitalid AND c.donorid='" + Session["id"] + "' AND status='Pending' UNION SELECT * FROM bbs.bloodrequest c JOIN bbs.admin b ON b.adminid=c.reqhospitalid AND c.donorid='" + Session["id"] + "' AND status='Pending';", myConn);
