<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital/HospitalMaster.Master" AutoEventWireup="true" CodeBehind="AddBlood.aspx.cs" Inherits="BBS.Hospital.AddBlood" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        ID="DropDownList1" Width="135px" runat="server" name="blood" CssClass="drop" AutoPostBack="True">
    ...
    <tr>
        ...
        <td style="border:none;"><cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
