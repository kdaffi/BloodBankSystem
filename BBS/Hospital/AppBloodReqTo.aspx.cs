...
{
    public partial class AppBloodReqTo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MySqlCommand SelectCommand = new MySqlCommand("SELECT * FROM bbs.bloodrequest a INNER JOIN bbs.hospital b ON a.bloodhospitalid=b.hospitalid AND a.reqhospitalid='" + Session["id"] + "' AND status='Approve' UNION SELECT * FROM bbs.bloodrequest a INNER JOIN bbs.admin c ON a.bloodhospitalid=c.adminid AND a.reqhospitalid='" + Session["id"] + "' AND status='Approve'", myConn);
