...
{
    public partial class BloodRequestTo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MySqlCommand SelectCommand = new MySqlCommand("SELECT * FROM bbs.bloodrequest a INNER JOIN bbs.hospital b ON a.bloodhospitalid=b.hospitalid WHERE reqhospitalid='" + Session["id"] + "' UNION SELECT * FROM bbs.bloodrequest a INNER JOIN bbs.admin c ON a.bloodhospitalid=c.adminid WHERE reqhospitalid='" + Session["id"] + "';", myConn);
            ...
            try
            {
                ...
                while (myReader.Read())
                {
                        Session["hospbloodid"] = myReader.GetString("bloodhospitalid");
                        Session["rid"] = myReader.GetString("requestid");
