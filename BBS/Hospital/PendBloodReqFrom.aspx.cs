...
namespace BBS.Hospital
{
    public partial class PendBloodReqFrom : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MySqlCommand SelectCommand = new MySqlCommand("SELECT * FROM bbs.bloodrequest a JOIN bbs.hospital b ON a.reqhospitalid=b.hospitalid AND a.bloodhospitalid='" + Session["id"] + "' AND status='Pending'", myConn);
