...
{
    public partial class PendBloodReqTo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myConn.Open();
            MySqlCommand SelectCommand = new MySqlCommand("SELECT * FROM bbs.bloodrequest a INNER JOIN bbs.hospital b ON a.bloodhospitalid=b.hospitalid AND a.reqhospitalid='" + Session["id"] + "' AND status='Pending' UNION SELECT * FROM bbs.bloodrequest a INNER JOIN bbs.admin c ON a.bloodhospitalid=c.adminid AND a.reqhospitalid='" + Session["id"] + "' AND status='Pending'", myConn);
