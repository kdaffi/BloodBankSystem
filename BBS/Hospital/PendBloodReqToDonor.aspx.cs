...
{
    public partial class PendBloodReqToDonor : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MySqlCommand SelectCommand = new MySqlCommand("SELECT * FROM bbs.bloodrequest a JOIN bbs.donor b ON a.donorid=b.donorid AND a.reqhospitalid='" + Session["id"] + "' AND status='Pending'", myConn);
